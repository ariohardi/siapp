...
.directive('cuppaDatepicker',function(){
    return {
        ...
        template:'<div class="winkel-calendar">\
                    ...
                    <div class="wc-date-popover" ng-class="{\'banner-true\': bigBanner == true}" ng-show="popover">\
                        ...
                        <table class="calendar-header">\
                            <tr>\
                                <td class="calendar-header-day">Mg</td>\
                                <td class="calendar-header-day">Sn</td>\
                                <td class="calendar-header-day">Sl</td>\
                                <td class="calendar-header-day">Rb</td>\
                                <td class="calendar-header-day">Km</td>\
                                <td class="calendar-header-day">Jm</td>\
                                <td class="calendar-header-day">Sb</td>\
                            </tr>\
                        </table>\
        ...
        link: function(scope, elem, attr){
            ...
            scope.cal_days_labels = ['Mg', 'Sn', 'Sl', 'Rb', 'Km', 'Jm', 'Sb'];
            scope.cal_full_days_lables = ["Minggu","Senin","Selasa","Rabu","Kamis","Jumat","Sabtu"];
            scope.cal_months_labels = ['Januari', 'Februari', 'Maret', 'April',
