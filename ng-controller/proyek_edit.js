angular.module("RDash").controller("Edit_proyek",function($scope,$rootScope,$http,$location,$timeout){
	$scope.loading = true;
	$rootScope.title_tag = "Edit Data Proyek";
	...
	$http.post('api/index.php/klien/data').success(function(data){
		...
		$http.post('api/index.php/geo/propinsi').success(function(data){
			...
			$http.post('api/index.php/proyek/detail',{
				ID : $scope.route[1]
	...
	$scope.submit = function(){
		$scope.loading = true;
		$http.post('api/index.php/proyek/simpan',$scope.FormData).success(function(data){
			$scope.loading = false;
			$.toast({
