angular.module("RDash").controller("Edit_cabang",function($scope,$rootScope,$http,$location,$timeout){
	$scope.loading = true;
	$rootScope.title_tag = "Edit Data Cabang";
	...
	$http.post('api/index.php/geo/propinsi').success(function(data){
		...
		$http.post('api/index.php/cabang/detail',{
			ID : $scope.route[1]
