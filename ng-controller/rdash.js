...
function rdWidgetFormGroup(){
	var e={
		...
		transclude:!0,
		template:'<div class="form-group"><label>{{label}}</label><div ng-transclude></div></div>',
		restrict:"E"
	};
	return e
}angular.module("RDash").directive("rdWidgetFormGroup",rdWidgetFormGroup);